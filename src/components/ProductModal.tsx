  ...
  return (
    <>
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-white rounded-2xl shadow-2xl z-50 m-4">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 bg-blue-100 hover:bg-blue-200 rounded-full transition-colors z-10"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-auto">
              ...
              <button
                onClick={onClose}
                className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-800 text-white font-bold rounded-lg hover:shadow-2xl hover:shadow-blue-600/30 transition-all duration-300"
              >
